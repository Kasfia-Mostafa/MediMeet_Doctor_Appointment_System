  ...
  return (
    <div className="fade-in">
      ...
      >
        <div
          className="stat-card"
          style={{ border: isEditing ? "2px solid var(--primary)" : "" }}
        >
          ...
          <div style={{ width: "100%" }}>
            ...
            {isEditing ? (
              <input
                ...
                onChange={(e) =>
                  handleChange("metrics", "heartRate", e.target.value)
                }
          ...
          <div style={{ width: "100%" }}>
            ...
            {isEditing ? (
              <input
                type="text"
                className="form-input"
                value={data.metrics.bloodPressure}
                onChange={(e) =>
                  handleChange("metrics", "bloodPressure", e.target.value)
                }
                placeholder="120/80"
                style={{ marginTop: "8px", padding: "8px" }}
              />
          ...
          <div style={{ width: "100%" }}>
            ...
            {isEditing ? (
              <input
                ...
                onChange={(e) =>
                  handleChange("metrics", "temperature", e.target.value)
                }
                style={{ marginTop: "8px", padding: "8px" }}
              />
            ) : (
          ...
          <div style={{ width: "100%" }}>
            ...
            {isEditing ? (
              <input
                type="number"
                className="form-input"
                value={data.metrics.weight}
                onChange={(e) =>
                  handleChange("metrics", "weight", e.target.value)
                }
                style={{ marginTop: "8px", padding: "8px" }}
              />
            ) : (
          ...
          <div className="flex flex-col gap-lg">
            ...
            <div>
              <div className="flex items-center justify-between mb-sm">
                ...
                {isEditing ? (
                  <input
                    type="number"
                    value={data.goals.steps}
                    onChange={(e) =>
                      handleChange("goals", "steps", e.target.value)
                    }
                  ...
                  >
                    {data.goals.steps} / {targetGoals.steps}
                  </span>
                )}
              </div>
              <div
              ...
              >
                <div
                  style={{
                    width: `${Math.min((data.goals.steps / targetGoals.steps) * 100, 100)}%`,
                    height: "100%",
            ...
            <div>
              <div className="flex items-center justify-between mb-sm">
                ...
                {isEditing ? (
                  <input
                    type="number"
                    value={data.goals.water}
                    onChange={(e) =>
                      handleChange("goals", "water", e.target.value)
                    }
                    style={{ width: "80px", padding: "4px" }}
                  />
                ) : (
                  <span
                    style={{ fontSize: "14px", color: "var(--text-muted)" }}
                  >
                    {data.goals.water} / {targetGoals.water}
                  </span>
                )}
              </div>
              <div
              ...
              >
                <div
                  style={{
                    width: `${Math.min((data.goals.water / targetGoals.water) * 100, 100)}%`,
                    height: "100%",
                    background: "var(--info)",
                    borderRadius: "4px",
                    transition: "width 0.5s ease",
            ...
            <div>
              <div className="flex items-center justify-between mb-sm">
                ...
                {isEditing ? (
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("goals", "sleep", e.target.value)
                    }
                    style={{ width: "80px", padding: "4px" }}
                  />
                ) : (
                  <span
                    style={{ fontSize: "14px", color: "var(--text-muted)" }}
                  >
                    {data.goals.sleep} / {targetGoals.sleep}
                  </span>
                )}
              </div>
              <div
              ...
              >
                <div
                  style={{
                    width: `${Math.min((data.goals.sleep / targetGoals.sleep) * 100, 100)}%`,
                    height: "100%",
        ...
        <div className="card">
          ...
          {history.length === 0 ? (
            <div className="empty-state" style={{ padding: "32px 0" }}>
              <HiOutlineClock
                style={{ fontSize: "48px", color: "var(--accent-light)" }}
              />
              <p style={{ marginTop: "12px" }}>
                Your logged history will appear here.
              </p>
            </div>
          ) : (
